...
class PathHolder {
    ...
    static final String SERVER_ADD_PATH = "/rest/secured/server";
    static final String SERVER_MODIFY_PATH = "/rest/secured/server";
    static final String SERVER_DELETE_PATH = "/rest/secured/server";
}
